class Actividad1{
    ...
    constructor(){
        ...
        this.preguntasActividad1 = [
            ...
            {
                noPregunta: 3,
                pregunta: 'La herramienta que nos permite dejar constancia de la entrevista es el Formato de Identificación de Institución de la Nacionalidad Extranjera o Mexicana o KYC (conocido como Formato de Identificación de la Cedente). Es el Formato de Identificación del Cliente de $7,500 dólares o el Formato de Identificación de Institución de la Nacionalidad Extranjera o Mexicana.',
                respuesta: 'v'
            },
            {
                noPregunta: 4,
